...
export default function Card({ title, description, author, repository, target }: any) {
    return (
        <div className="basis-1/3 h-full border-green card-anim min-w-[300px]">
            <div className="relative flex flex-col justify-between block p-6 pt-4 bg-black border border-gray-100 rounded-lg shadow-md h-[200px]">
                <div className="flex flex-col justify-start">
                    ...
                    <p className="font-normal text-white text-s text-clip max-h-[75px] overflow-y-clip overflow-x-clip">
                        {description}
                    </p>
                </div>
